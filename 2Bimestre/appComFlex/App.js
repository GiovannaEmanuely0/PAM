...
export default function App() {
  return (
    ...
    <View style={styles.container}>
      ...
      <View style={styles.primeiraDivisao}>
        ...
        <View style={styles.linha}>
          <View style={styles.coluna1}>
            ...
            <Text style={styles.bold}>$236,678.25</Text>
          </View>
        </View>       
      ...
      <View style={styles.segundaDivisao}>
        ...
        <View style={styles.linha}>
          <View style={styles.colunan}>
            <Text  style={styles.paragrafo2}>INCOMES</Text>
            <Text style={styles.bold}>$267</Text>
          </View>

          <View style={styles.coluna}>
            <Text style={styles.paragrafo2}>EXPENSES</Text>
